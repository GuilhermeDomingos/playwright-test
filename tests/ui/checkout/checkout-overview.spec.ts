...
test.describe('Checkout Overview', () => {
    ...
    test('should display checkout overview page @ui @regression @checkout', async ({checkoutOverviewPage, page}) => {
        await expect(page).toHaveURL(/checkout-step-two/);
    ...
    test('should validate product data in checkout overview @ui @regression @checkout', async ({checkoutOverviewPage}) => {
    ...
    test('should validate payment and shipping information @ui @regression @checkout', async ({checkoutOverviewPage}) => {
    ...
    test('should validate price total information @ui @regression @checkout', async ({checkoutOverviewPage}) => {
    ...
    test('should return to inventory when cancel is clicked @ui @regression @checkout @inventory', async ({checkoutOverviewPage, inventoryPage, page}) => {
    ...
    test('should finish checkout successfully @ui @regression @checkout', async ({checkoutOverviewPage, page}) => {
